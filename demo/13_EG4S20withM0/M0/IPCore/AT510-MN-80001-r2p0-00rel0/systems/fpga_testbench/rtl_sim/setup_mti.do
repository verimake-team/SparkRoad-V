...
# -----------------------------------------------------------------------------
#
# Setup script for Modelsim / Questasim
...
run 1us
foreach addr $addr_list { noforce $addr }
...
mem load -infile itcm0.hex -format hex tb_fpga/uSSRAM1A/bank0
mem load -infile itcm1.hex -format hex tb_fpga/uSSRAM1A/bank1
mem load -infile itcm2.hex -format hex tb_fpga/uSSRAM1A/bank2
mem load -infile itcm3.hex -format hex tb_fpga/uSSRAM1A/bank3

mem load -infile itcm4.hex -format hex tb_fpga/uSSRAM1B/bank0
mem load -infile itcm5.hex -format hex tb_fpga/uSSRAM1B/bank1
mem load -infile itcm6.hex -format hex tb_fpga/uSSRAM1B/bank2
mem load -infile itcm7.hex -format hex tb_fpga/uSSRAM1B/bank3

# Preload ZBT memories, (SSRAM2 and 3) to avoid X in read data
mem load -filldata 0 tb_fpga/uSSRAM2/bank0
mem load -filldata 0 tb_fpga/uSSRAM2/bank1
mem load -filldata 0 tb_fpga/uSSRAM2/bank2
mem load -filldata 0 tb_fpga/uSSRAM2/bank3

mem load -filldata 0 tb_fpga/uSSRAM3/bank0
mem load -filldata 0 tb_fpga/uSSRAM3/bank1
mem load -filldata 0 tb_fpga/uSSRAM3/bank2
mem load -filldata 0 tb_fpga/uSSRAM3/bank3
