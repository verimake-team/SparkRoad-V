 ...
 ** File	:	C:/Users/zhang/Desktop/work/FPGA/sparkroadV/15_ov5640_sdram/al_ip/ramfifo.v
 ** Date	:	2022 10 28
...
module ramfifo #(parameter DATA_WIDTH_W = 16, 
    ...
    fifo_cross_domain_addr_process_al_ramfifo #(.ADDR_WIDTH(ADDR_WIDTH_W)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_ramfifo #(.ADDR_WIDTH(ADDR_WIDTH_R)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
                .secondary_asreset_i(rd_rst), 
                .primary_clk_i(clkw), 
                .secondary_clk_i(clkr), 
                .primary_addr_i(shift_wraddr), 
                .secondary_addr_o(wr_to_rd_addr)) ; 
    ram_infer_ramfifo #(.DATAWIDTH_A(DATA_WIDTH_W),
...
// ===========================================================================
module fifo_cross_domain_addr_process_al_ramfifo #(parameter ADDR_WIDTH = 9) (
