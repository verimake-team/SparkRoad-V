...
assign current_R = {current_pixel[15:11],3'b000};
assign current_G = {current_pixel[10:5],2'b00};
assign current_B = {current_pixel[4:0],3'b000};

always@(posedge wrreq )
begin
	data_out <=((current_R*5)>>4) + ((current_G*9)>>4) + ((current_B*2)>>4);
end
