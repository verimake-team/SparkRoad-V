 ...
 ** File	:	C:/Users/zhangzzp/Desktop/work/TD/16_ov2640_sdram/al_ip/ramfifo2.v
 ** Date	:	2024 10 23
 ** TD version	:	5.6.119222
\************************************************************/
module ramfifo2 #(parameter DATA_WIDTH_W = 16, 
    ...
    fifo_cross_domain_addr_process_al_ramfifo2 #(.ADDR_WIDTH(ADDR_WIDTH_R)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_ramfifo2 #(.ADDR_WIDTH(ADDR_WIDTH_W)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
                .secondary_asreset_i(rd_rst), 
                .primary_clk_i(clkw), 
                .secondary_clk_i(clkr), 
                .primary_addr_i(wr_addr), 
                .secondary_addr_o(wr_to_rd_addr)) ; 
    ram_infer_ramfifo2 #(.DATAWIDTH_A(DATA_WIDTH_W),
...
`timescale 1ns/1ps
module fifo_cross_domain_addr_process_al_ramfifo2 #(parameter ADDR_WIDTH = 9) (
...
`timescale 1ns/1ps
module ram_infer_ramfifo2 (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
