...
set rc [catch {
  ...
  import_db {../syn_1/Buttons&LED_gate.db}
  read_sdc
  place
  export_db {Buttons&LED_place.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  route
  report_area -io_info -file Buttons&LED_phy.area
  export_db {Buttons&LED_pr.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  export_bid Buttons&LED_inst.bid
  bitgen -bit "Buttons&LED.bit"
} RESULT]
if {$rc} {
  step_error bitgen
  return -code error $RESULT
